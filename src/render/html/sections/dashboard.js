...
<div class="grid-2">
  <div class="card chart-card">
    ...
    <div class="chart-wrap">
      <canvas id="chart-state-pie" aria-label="State distribution pie"></canvas>
    </div>
  </div>
  <div class="card chart-card">
    <h3>NEW vs REMOVED by Severity</h3>
    <div class="chart-wrap">
      <canvas id="chart-new-removed" aria-label="NEW vs REMOVED bar"></canvas>
    </div>
  </div>
</div>
...
<div class="card chart-card" style="margin-top:12px;">
  ...
  <div class="chart-wrap">
    <canvas id="chart-severity-stacked" aria-label="Severity stacked bar"></canvas>
  </div>
</div>
